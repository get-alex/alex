...
var EXPRESSION_ABBREVIATION_ENGLISH_PREFIX, EXPRESSION_ABBREVIATION_ENGLISH_PREFIX_SENSITIVE, EXPRESSION_ELISION_ENGLISH_AFFIX, EXPRESSION_ELISION_ENGLISH_PREFIX, EXPRESSION_APOSTROPHE;
...
function mergeEnglishPrefixExceptions(child, index, parent) {
    var children, node, prev, next, prevValue;
...
function mergeEnglishElisionExceptions(child, index, parent) {
    var siblings, length, node, other, value;
...
parserPrototype.tokenizeSentencePlugins = [Parser.plugin(mergeEnglishElisionExceptions)].concat(parserPrototype.tokenizeSentencePlugins);

parserPrototype.tokenizeParagraphPlugins = [Parser.modifier(mergeEnglishPrefixExceptions)].concat(parserPrototype.tokenizeParagraphPlugins);
